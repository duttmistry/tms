  ...
  constructor(routes: Routes[]) {
    ...
    this.port =
      _NODE_ENV == 'development'
        ? developmentConfig.default.PROJECT_DOC_APIS_PORT
        : _NODE_ENV == 'staging'
        ? stagingConfig.default.PROJECT_DOC_APIS_PORT
        : productionConfig.default.PROJECT_DOC_APIS_PORT;
    //this.port = 3501; //3003  tms staging port
