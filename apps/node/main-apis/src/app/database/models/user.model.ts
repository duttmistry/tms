...
import { iUser, iUserEmail, iUserAddress, iUserEducation, iUserCertificates, iUserworkDetails, iUserExperince } from '../interface/user.interface';
...
export class UserModel extends Model<iUser, OptionalAttributes> implements iUser {
  ...
  declare workdetails: iUserworkDetails;
  declare experience: Array<iUserExperince>;
