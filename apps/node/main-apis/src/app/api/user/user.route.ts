...
class UserRoute implements Routes {
  ...
  private initializeRoutes() {
    // User Routes
    this.router.get(`/user`, [auth.default,UserValidation], this.controller.getUserById);
    ...
    this.router.get(`/users/birthday`, this.controller.getUserBirthdayWorkday);
    this.router.post(`/user/member/logout`, auth.default, this.authController.memberLogout);
    this.router.post(`/user/time`, auth.default, this.controller.manualUserTimeUpdate);
    ...
    this.router.post(`/member/break`, auth.default, this.authController.memberBreak);
    this.router.post(`/system/auto/logout`, auth.default, this.authController.systemAutoLogout);
    this.router.post(`/getDeviceToken`, auth.default, this.authController.getDeviceToken);
    ...
    // User Time History
    this.router.get(`/user/time/history/`, [auth.default, UserValidation], this.controller.getUserTimeHistory);
    


    //Check Validation
    this.router.get(`/user/validation`, [auth.default, UserValidation], this.controller.checkValidation);
  }
}
