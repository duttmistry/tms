...
export const environment = {
  ...
  base_url: 'http://192.168.0.204:4001/', // local
  document_base_url: 'http://192.168.0.204:4002/', // local
  leave_base_url: 'http://192.168.0.204:4003/', // local
  task_base_url: 'http://192.168.0.204:4004/', // local

  // base_url: `${stagingEndPoint}3002/`, //staging
  // document_base_url: `${stagingEndPoint}3003/`, //staging
  // leave_base_url: `${stagingEndPoint}3004/`, //staging
  // task_base_url: `${stagingEndPoint}3005/`, //staging

  /** DEVELOP */

  // base_url: `${developEndPoint}3500/`, //develop
  // document_base_url: `${developEndPoint}3501/`, //develop
  // leave_base_url: `${developEndPoint}3502/`, //develop
  // task_base_url: `${developEndPoint}3503/`, //develop

  /** HTTPS */

  // base_url: ' https://tms-staging-core-apis/',
  // document_base_url: ' https://tms-staging-documents-apis/',
  // leave_base_url: ' https://tms-staging-leave-apis/',
  // task_base_url: ' https://tms-staging-task-apis/',
